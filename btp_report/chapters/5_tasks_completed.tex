...
The behaviour was correct rather than defective. The energy model then in use charged propulsion at a constant rate and hovering cheaply, so a weak link imposed no penalty beyond a longer hover, and a longer hover was inexpensive, whereas descending cost climb energy and narrowed the footprint. Flying as high as permitted was genuinely optimal for the model as written, and no amount of tuning would have produced descent.
